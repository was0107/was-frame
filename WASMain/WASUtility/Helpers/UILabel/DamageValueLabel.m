...
- (void)startAnimationWithAnimationTypeAllJump {
    self.hidden = NO;
    [self startPopAnimationWithDelay:0.0];
}

- (void)startAnimationWithAnimationTypeAlpha {
    self.hidden = NO;
    orgPos = self.center;
    self.alpha = 0.0;
...
- (void)startAnimationWithAnimationTypeSonJump {
...
- (void)startAnimation {
    [self startAnimationWithAnimationType:DamageAnimationTypeSonJump];
}
...
- (void)startAnimationWithAnimationType:(DamageAnimationType)type {
    ...
    switch (type) {
        case DamageAnimationTypeAllJump:
            [self startAnimationWithAnimationTypeAllJump];
            break;
        case DamageAnimationTypeAlpha:
            [self startAnimationWithAnimationTypeAlpha];
            break;
        case DamageAnimationTypeSonJump:
        default:
            [self startAnimationWithAnimationTypeSonJump];
            break;
    }
}
